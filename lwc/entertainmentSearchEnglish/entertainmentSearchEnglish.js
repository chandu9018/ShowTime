...
import { OMNIDEF } from './entertainmentSearchEnglish_def.js';
import tmpl from './entertainmentSearchEnglish.html';
import tmpl_nds from './entertainmentSearchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class entertainmentSearchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
